...
Uvažujme „standardní“ grafy $K_n$, $P_n$, $C_n$ a $K_{m,n}$ z přednášky. Které z nich jsou isomorfní?
\end{problem}
...
\begin{problem}[Nedokonalý isomorfismus]
Připomeňme si definici isomorfismu:
\[
