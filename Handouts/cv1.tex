...
% Uvažujeme množinu států $A = \{ \text{Francie}, \text{Německo}, \text{Česko}, \text{Slovensko} \}$ a nechť $V(x,y)$ znamená, že stát $x$ vyváží víno do státu $y$. Vztah $V$ je znázorněn na diagramu níže.

% \begin{wrapfigure}{r}{0.4\textwidth}
%     \centering
%     \includegraphics[width=2cm]{states.pdf}
% \end{wrapfigure}
% % \begin{problem}[Státy]
